						...
						if (msg.getMessage() != null || msg.getImage() != null) {
							...
							if (message.contains("USERNAME100")) {
								...
								for(String str : msg.getRecipient()){
									// Mottagare är whitespace, skicka till alla
									if(str.equals("")){
									...
									// Mottagare finns, skicka till dem
									if (arr.contains(str)) {
										String time = df.format(new Date());
										String messageLf = time + " " + message
												+ "\n";
									...
									if(!arr.contains(str) && !str.equals("")){
										...
										ImageIcon image = msg.getImage();
										String sender = msg.getSender();
										sendMessage(new Message(Message.OFFLINE, mess, image, rec, sender));
									}
